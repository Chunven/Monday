    ...
    <v-card class="pa-6 rounded-lg">
                ...
                <v-col cols="6">
                  <v-list>
                    ...
                    <v-list-item
                      ...
                      :key="index"
                      :class="{ 'active-siz': index === activeSizeIndex }"
      ...
      <v-row no-gutters>
        <v-col class="mt-4 pa-6" cols="12" sm="6">
          ...
          <span class=""
            >ໂຕະເຕະບານ ລຸ້ນທີ່ໃຊ້ແຂ່ງຂັນ ສຳລັບຈັດກິດຈະກຳແຂ່ງຂັນ ຫຼື ຜ່ອນຄ່າຍ
        ...
        <v-col class="mt-4 pa-6" cols="12" sm="6">
          <v-list-item-title> <h3>Specification</h3> </v-list-item-title>
          <span>
            Brand: No <br />
